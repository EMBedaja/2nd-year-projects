...
<div id="id01" class="modal">
  <div #id="form-update" class="modal-content">
    <div class="container">
      <ul>
      <li><h2>Change User Status</h2></li>
      <p style="margin-left:20px;">Are you sure you want to change user status?</p>
      <div class="clearfix"> 
      
        <?php
         if($user->get_user_status($id) == "1"){ 
         ?>
          <li> <button class="confirmbtn" onclick="disableSubmit()" style="margin-left:10px;">Confirm</button></li>
        <?php }else {?>
...
<div id="id02" class="modal">
  <div #id="form-update" class="modal-content">
    <div class="container">
   <ul>
     <li> <h2>Update User Password</h2></li>
