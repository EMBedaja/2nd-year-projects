...
<form method="POST" id="userform" onsubmit="return validateForm(event)" action="processes/process.user.php?action=new">
        <div id="form-block-half" >
            ...
            <input type="text" id="fname" class="input" name="firstname" placeholder="Your name.." pattern="[A-Z][a-z]{1,15}"
		title="Firstname should contain uppercase letter. e.g. Meisha" required>
        
            <label for="lname">Last Name</label>
            <input type="text" id="lname" class="input" name="lastname" placeholder="Your last name.." pattern="[A-Z][a-z]{1,15}"
		title="Latname should contain uppercase letter. e.g. Lee" required>
        ...
        <div id="form-block-half">
            ...
            <input type="password" id="password" class="input" name="password" onkeyup='check();' placeholder="Enter password.."  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
